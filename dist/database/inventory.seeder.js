...
async function seedInventory() {
    ...
    try {
        ...
        const SupplyBatchModel = mongoose_1.default.model("SupplyBatch", product_schema_1.SupplyBatchSchema);
        const SupplierModel = mongoose_1.default.model("Supplier", supplier_schema_1.SupplierSchema);
